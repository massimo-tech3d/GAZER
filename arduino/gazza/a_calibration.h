...
// quarter of full range (16384) because I'm not expecting more that 1g, the sensors records up to 2g
// and I don't expect more than half the range since the scope never gets upside down
