defmodule UiWeb.Components.DeepSkySelect do
      ...
      <.form let={f1} for={:dso} phx-submit="dso" phx-target={@myself} class="container flex flex-row items-center">
          <div class="flex flex-col">
            <div class="flex">
              ...
              <%= select(f1, :catalogue, @catalogues, [selected: @catalogue, class: "border text-s rounded-r-md  border-red-700 text-gray-500 bg-neutral-800"]) %>
              <%= text_input(f1, :dso_id, [class: "rounded-lg text-neutral-500 bg-neutral-800 border-red-700", size: "2", value: "1"])%>
              <br><br>
            </div>
